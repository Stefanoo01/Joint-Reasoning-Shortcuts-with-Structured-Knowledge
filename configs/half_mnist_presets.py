...
HALF_MNIST_PRESETS: Dict[str, HalfMnistPreset] = {
    ...
    "add_broad_search_v1": HalfMnistPreset(
        ...
        lam1=0.2,
        lam2=0.0,
        notes="Addition experiment with a broader symbolic search space while keeping clause shapes structured.",
    ),
    "add_sum_relaxed_v1": HalfMnistPreset(
        ...
        lam1=0.2,
        lam2=0.0,
        notes="Addition experiment close to the base setup, but with a slightly wider search space for sum_is.",
    ),
